        ...
        <aside :class="sidebarOpen ? 'w-64' : 'w-20'" 
            ...
            <div class="flex items-center justify-between p-5 border-b border-slate-100">
                <div x-show="sidebarOpen" class="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 class="text-xl font-bold bg-gradient-to-r from-blue-600 to-indigo-700 bg-clip-text text-transparent">SAPRAS</h1>
            ...
            <div class="p-3 border-t border-slate-100">
                <div class="relative" x-data="{ profileOpen: false }">
                    <button @click="profileOpen = !profileOpen" 
                            class="w-full flex items-center gap-3 p-3 hover:bg-slate-50 rounded-xl transition-colors">
                        @if(auth()->user()->foto_profil)
                            <img src="{{ asset('storage/' . auth()->user()->foto_profil) }}" 
                                 class="w-10 h-10 rounded-full object-cover ring-2 ring-slate-200 flex-shrink-0">
                        @else
                            <div class="w-10 h-10 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-full flex items-center justify-center ring-2 ring-slate-200 flex-shrink-0">
                        ...
                        <i x-show="sidebarOpen" class="fas fa-ellipsis-v text-slate-400 flex-shrink-0"></i>
                    </button>
            ...
            <div class="p-3 border-t border-slate-100">
                <div class="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                    <div class="flex items-center gap-3 min-w-0">
                        ...
                        @else
                            <div class="w-10 h-10 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-full flex items-center justify-center flex-shrink-0">
                                <span class="text-white font-bold text-sm">
                                    {{ strtoupper(substr(auth()->user()->nama_pengguna, 0, 2)) }}
                                </span>
                            </div>
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit" class="text-slate-400 hover:text-red-600 flex-shrink-0" title="Logout">
