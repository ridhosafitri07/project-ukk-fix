            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3">
                <div class="space-y-1">
                    <a href="{{ route('petugas.dashboard') }}" 
                       class="sidebar-link flex items-center space-x-3 px-4 py-3 rounded-xl text-slate-700 {{ request()->routeIs('petugas.dashboard') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('petugas.riwayat.index') }}" 
                       class="sidebar-link flex items-center space-x-3 px-4 py-3 rounded-xl text-slate-700 {{ request()->routeIs('petugas.riwayat.*') ? 'active' : '' }}">
        ...
        <div class="flex-1 flex flex-col h-screen overflow-hidden" 
            ...
            <footer class="bg-white border-t border-slate-200 py-4 px-6 lg:px-8">
                <div class="flex flex-col md:flex-row items-center justify-between text-sm text-slate-600 space-y-2 md:space-y-0">
                    ...
                    <p class="text-slate-500">v1.0.0 - Petugas Panel</p>
                </div>
            </footer>
        </div>
    </div>
